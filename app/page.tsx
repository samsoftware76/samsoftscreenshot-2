                  ...
                  {instructions.trim().length > 0 && (
                    <div className="mt-6">
                      <button
                        ...
                        disabled={isAnalyzing}
                        className="w-full py-4 px-4 bg-purple-600 text-white rounded-xl font-bold shadow-lg hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 flex items-center justify-center gap-2 transform transition-[transform,colors] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed text-lg"
                      >
                        {isAnalyzing ? (
                          <>
